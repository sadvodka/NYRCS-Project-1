...
class Player(pygame.sprite.Sprite):
    def __init__(self, color, start_x, start_y, controls):
        ...
        self.skill_cooldown = 0.8 # seconds for skill cooldown
...
class Fireball(pygame.sprite.Sprite):
    def __init__(self, x, y, direction):
        ...
        # Load the fireball image instead of creating a surface
        self.image = pygame.image.load("fireball_image.png") # Replace with your image file
        self.rect = self.image.get_rect()
...
controls_player2 = {'up': pygame.K_UP, 'down': pygame.K_DOWN, 'left': pygame.K_LEFT, 'right': pygame.K_RIGHT, 'skill': [pygame.K_LSHIFT, pygame.K_END]}  # Support both shift keys
