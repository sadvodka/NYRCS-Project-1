...
monster_data = {
    ...
    "Tank": {"health": 200, "attack_damage": 15, "roaming_speed": 0.5, "hunting_speed": [1,1,1.5,1.5,1.5], "image": pygame.image.load("tank/roam/0.png"), "image_scale": 2.5, "hitbox_rect": pygame.Rect(0,0,150,200), "animation_speed": 0.1, "roam_animation_speed": 0.12, "death_animation_speed": 0.2, "notice_radius": 600},
}

game_stats = {
    "enemies_killed_or_removed": 0, "necromancer_death_count": 0, "nightborne_death_count": 0, "tank_death_count": 0, "coins": 0, "health_potion_heal": 20, "current_wave": 1, "number_of_enemies": [5, 6,7], "wave_cooldown": 6000, "num_health_potions": 3
}
