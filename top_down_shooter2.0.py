...
tank_death_sound = pygame.mixer.Sound("sounds/tank death.mp3")
...
class GameLevel(pygame.sprite.Group): 
    ...
    def spawn_enemies(self):
        ...
        enemy_name = ["necromancer", "nightborne", "tank"]
...
tank_image = pygame.image.load("tank/sprites/00.png").convert_alpha()
tank_image = pygame.transform.rotozoom(tank_image,0,2)
tank_image_rect = tank_image.get_rect(center = (250,360))
